...
Attori: **Paziente / Caregiver** (attore primario), **Medico** (attore primario con permessi estesi), e **Dispositivo ESP32** (attore secondario che immette telemetria e riceve configurazioni).
...
3. L'ESP32 pubblica una lettura MQTT completa (frequenza respiratoria, BPM, Temp).
