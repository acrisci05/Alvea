...
TOPIC = "alvea/monitor/data"   # topic corretto: quello che ascolta il backend
...
def make_reading(scenario):
    ...
    return {
        ...
        "timestamp": time.time(),
        "bpm": bpm,
        "temperature": skin_temp,    # nome corretto per il backend
        "resp_rate": resp_rate,      # nome corretto per il backend
